...
% Education
\section{Education}
    \datedexperience{BSc in Computer Science}{}
    \explanation{Utrecht University}
    \datedexperience{Propedeuse Bachelor of Creative Media and Game Technologies, Game Development}{}
...
% Experience
\section{Experience}
    \datedexperience{Utrecht Companion to the Earth}{}
...
\section{Some of my Projects}
    ...
    \newcommand{\prp}{ Termdaw: A DAW in a terminal. Written in Rust. \href{https://github.com/codybloemhard/termdaw}{src} }
    \newcommand{\listofextras}{ \prp, \pro, \prn, \pra, \prb, \prc, \prd, \pre, \prg, \prh, \pri, \prj, \prk, \prl }
    %
